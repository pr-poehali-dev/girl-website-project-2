...
const TIMELINE = [
  { date: 'Начало', title: 'Первая встреча', desc: 'Мы познакомились глупо, на глупом сайте знакомств. Тогда я ещё подумать не мог, что та девочка, рассказывающая мне про то, что ей снятся кошмары — будет той самой.', emoji: '🌹' },
